...
import util
from kg import framework,task,model,dataset
...
if __name__ == "__main__":
    ...
    for job_id, cfg in enumerate(cfgs):
        ...
        if "checkpoint" in cfg:
            ...
            total_params = sum(param.numel() for param in solver.model.parameters())
            ...
            if cfg.train.num_batch == 0:
                ...
                if "test" in cfg:
                    ...
                    solver.evaluate("test", keep_order=True)
                else:
                    # normal evaluation
                    solver.evaluate("valid",keep_order=True)
